...
\HAWThesisProperties{Author={Shirin Bediako \\ MatrNr.: 2088775 \\ shirin.bediako@haw-hamburg.de}
                    ,Title={Welchen Einfluss hat die Qualifikation der Kita-Leitung auf die fr"uhkindlichen Bildung in Kindertageseinrichtungen?}
                    ,SubTitle={}
                    ,EnglishTitle={}
                    ,ThesisType={Hausarbeit}
                    ,ExaminationType={Institutionsentwicklung/Management}
                    ,DegreeProgramme={Bildung und Erziehung in der Kindheit}
                    ,ThesisExperts={Prof.\ Petra\ Strehmel}
                    ,ReleaseDate={26. Februar 2015}
                  }
...
% \includepdf[pages=-, addtotoc={1,chapter,0,Interview mit Herrn Strauﬂ,chap:anhang_1}, scale=0.90, offset=6mm -5mm]{Interview.pdf}
%
% \includepdfset{pagecommand={\pagestyle{scrheadings}}}
